...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mOpenFlash = (TextView) view.findViewById(R.id.open);
        mCloseFlash = (TextView) view.findViewById(R.id.close);
        mOpenFlash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // CommonUtil.getImageFromAlbumByMultiple(getActivity(), 1);
            }
        });
        mCloseFlash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                switchFlash();
            }
