...
public class MessageReadListFragment extends BaseFragment {
    ...
    static MessageReadListFragment newInstance(int index) {
        MessageReadListFragment myFragment = new MessageReadListFragment();
    ...
    protected int getContentView() {
        return R.layout.fragment_message_read_list;
    }
    ...
    protected void initView(View view) {
        mRecyclerView = (RecyclerView) getActivity().findViewById(R.id.rv_read);
    ...
    public void setData(List<Member> readMemberList) {
        ...
        footerTv.setText("已读成员" + noticeList.size() + "人");
        mNoticeAdapter.notifyDataSetChanged();
       /* switch (index) {
            case TAG1:
                //已读成员
                footerTv.setText("已读" + noticeList.size() + "人");
                break;
            case TAG2:
                //未读成员
                footerTv.setText("未读" + noticeList.size() + "人");
                break;
            default:
                break;
        }
